...
class HMC5883L:
    ...
    def __init__(self, scl=22, sda=21, address=13, gauss='0.88', declination=(-2, 53)):
    ...
    def read(self):
        ...
        self.i2c.readfrom_mem_into(13, 0x3, data)
    ...
    def heading(self):
        ...
        return degrees, minutes, x, y, z

    def format_result(self):
        degrees, minutes, x, y, z = self.heading()
